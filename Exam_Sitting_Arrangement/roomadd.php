...
$seat_no = $_POST['seat_no'];
  ...
  // }
    ...
    $query="insert into room(name,seats_available,capacity) 
    values('$room','$seat_no','$seat_no')";
...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Add Rooms</h2>

<div class="foote">  

  <div class="box">

  Room No. <input type="text" placeholder="Enter Room Number" name="room_no" id = "room_no" required style="font-size: 15px;border-radius: 5px; margin-left: 75px; width: 300px;">

  <br><br>

  Seat Capacity <input type="text" placeholder="Enter Room Capacity" name="seat_no" id = "seat_no" required style="font-size: 15px;border-radius: 5px;margin-left: 50px; width: 300px;">
  <br><br>

  <button class="btn" type="submit" style="margin-left: 130px;">Add Room</button>
