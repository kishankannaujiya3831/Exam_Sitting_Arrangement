...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Department View</h2>
...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $query="UPDATE department SET sno = '$sno', department_name = '$dep' WHERE sno = $sno";
...
if(isset($_GET['upd'])){
?>
<form action="departmentview.php" method="post">
 <tr>
 <td align = "center"><input type="text" placeholder="S.No" name="sno"  id="sno" required style="font-size: 15px;">
      </td > 

      <td align = "center"><input type="text" placeholder="department_name" name="dep"  id="dep" required style="font-size: 15px;">
      </td> 
...
while ($rows=$result->fetch_assoc()) 
  ...
  ?>    
      ...
      <td align = "center"><?php echo $rows['sno']; ?></td>
        ...
        <td  align= "center" ><a href="departmentview.php?upd=<?php echo $rows['sno'];?>"><i class="fa fas fa-edit" style="color:gray; font-size: 40px; " ></i></a> </td>

        <td  align= "center" ><a href="delete.php?delde=<?php echo $rows['sno'];?>"><i class="fa fas fa-trash" style="color:gray; font-size: 40px; " ></i></a> </td>
      </tr>
  <?php
    }
  ?> 
