...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Rooms View</h2>
...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $query="UPDATE room SET name= '$rno' , seats_available = '$sec',capacity = '$cap' WHERE name = '$rno'";
...
if(isset($_GET['upd'])){
  ...
  <form action="roomview.php" method="post">
   <tr>
        <td align = "center">
        <input type="text" placeholder="Room No" name="rno"  id="rno" required style="font-size: 15px;">
        </td>

        <td align = "center"><input type="text" placeholder="Seat Available" name="sec"  id="sec" required style="font-size: 15px;">
        </td>

        <td align = "center"><input type="text" placeholder="Capacity" name="cap"  id="cap" required style="font-size: 15px;">
        </td>

        <td colspan="2" align="center"><button class="btn success" onclick="alert('Are you sure!')">Update</button></td>
      </tr>
   </form>
      <?php 
}
...
$result=$link->query($query);
  ...
  ?>    <tr>
        ...
        <td align = "center"><?php echo $rows['seats_available']; ?></td>
        <td align = "center"><?php echo $rows['capacity']; ?></td>
        <td  align= "center" ><a href="roomview.php?upd=<?php echo $rows['name']; ?>"><i class="fa fas fa-edit" style="color:gray; font-size: 40px; " ></i></a></td>
        <td  align= "center" ><a href="delete.php?delro=<?php echo $rows['name']; ?>"><i class="fa fas fa-trash" style="color:gray; font-size: 40px; " ></i></a></td>
      </tr>
  <?php
    }
  ?>
