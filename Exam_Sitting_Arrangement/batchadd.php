                ...
                <div class="w3-button w3-block w3-left-align" onclick="myAccFunc3()">
                  ...
                  <div class="w3-button w3-block w3-left-align" onclick="myAccFunc4()">
                    ...
                    <div id="demoAcc4" class="w3-hide w3-white w3-card">
                      ...
                      <a href="durationveiw.php" class="w3-bar-item w3-button">View</a>
...
$batch = $_POST['batch_no'];
  ...
  // }
    ...
    $query="insert into batch(department_name,batch_no) 
    values('$dep','$batch')";
...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Add Batch</h2>

<div class="foote">  

  <div class="box">

  <!-- S.No <input type="text" placeholder="S.No" name="sno" id = "sno" required style="font-size: 15px;border-radius: 5px; margin-left: 75px; width: 300px;">
<br><br> -->
  Batch No. <input type="text" placeholder="Enter Batch Number" name="batch_no" id = "batch_no" required style="font-size: 15px;border-radius: 5px; margin-left: 75px; width: 300px;">

  <br><br>

  Department <input type="text" placeholder="Department Name" name="dep" id = "dep" required style="font-size: 15px;border-radius: 5px; margin-left: 75px; width: 300px;">

  <br><br>

  <button class="btn" type="submit" style="margin-left: 130px;" onclick= "alert('bacthadded seccesfully!')">Add Batch</button>
