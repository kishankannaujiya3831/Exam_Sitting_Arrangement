...
<form action="studentadd1.php" method="post">
              ...
              <div class="w3-button w3-block w3-left-align" onclick="myAccFunc2()">
                ...
                <div class="w3-button w3-block w3-left-align" onclick="myAccFunc3()">
                  ...
                  <div id="demoAcc3" class="w3-hide w3-white w3-card">
                    ...
                    <a href="roomview.ph" class="w3-bar-item w3-button">View</a>
...
$batch = $_POST['batch_no'];
  ...
  // }
    ...
    $query="insert into student_details(id,year,name,dept,batch) 
    values('$roll','$year','$Name','$dep','$batch')";
...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Add Student</h2>
...
<div class="foote">  
  ...
  Department 
  <input type="text" placeholder="Department" name="dep" id ="dep" required style="font-size: 15px;border-radius: 5px; margin-left: 45px; width: 300px;">
  ...
  year  <input type="text" placeholder="year" name="year" id ="year" required style="font-size: 15px;border-radius: 5px; margin-left: 110px; width: 300px;">
  <br><br>
