...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Student View</h2>
...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $query="UPDATE student_details SET id ='$Ro',year ='$ye',name = '$ns', dept = '$dep',batch = '$btn' WHERE id='$Ro' ";
...
<form action="studentview.php" method="post">
 <tr style="width: 70%;">
      ...
      <td align = "center"><input type="text" placeholder="Roll_No" name="Roll_No"  id="Roll_No" required style="font-size: 12px; width:100%;">
      </td>

      <td align = "center"><input type="text" placeholder="year" name="ye"  id="ye" required style="font-size: 12px; width:100%;">
      </td>

      <td align = "center"><input type="text" placeholder="name_student" name="ns"  id="ns" required style="font-size: 12px; width:100%;">
      </td> 


      <td align = "center"><input type="text" placeholder="department_name" name="dep"  id="dep" required style="font-size: 12px; width:100%;">
      </td> 
<!-- 
      <td align = "center"><input type="text" placeholder="Room.no" name="rn"  id="rn" required style="font-size: 12px; width:100%;">
      </td>

      <td align = "center"><input type="text" placeholder="Seat no" name="sn"  id="sn" required style="font-size: 12px; width:100%;">
      </td>  -->

      <td align = "center"><input type="text" placeholder="batch no" name="btn"  id="btn" required style="font-size: 12px; width:100%;">
      </td>
<!-- 
      <td align = "center"><input type="text" placeholder="Cours No" name="cor"  id="cor" required style="font-size: 12px; width:100%;">
      </td> -->
...
$result=$link->query($query);
  ...
  <tr style="width: 70%;">
        ...
        <td  align= "center" ><a href="studentview.php?upd=<?php echo $rows['id']; ?>"><i class="fa fas fa-edit" style="color:gray; font-size: 25px; " ></i></a></td>
        <td align = "center"><a href="delete.php?delst=<?php echo $rows['id']; ?>"><i class="fa fas fa-trash" style="color:gray; font-size: 25px; " ></i></a></td>
      </tr>
  <?php
    }
  ?> 
