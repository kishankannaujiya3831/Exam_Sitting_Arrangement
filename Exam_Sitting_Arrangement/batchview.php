...
<h2 style="margin-left: 220px;color: #FF7F50;margin-top: -30px;">Batch View</h2>
...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $query="UPDATE batch SET sno = '$sno', department_name = '$dep', batch_no = '$btn' WHERE sno =$sno";
...
if(isset($_GET['upd'])){
  ?>
  <form action="batchview.php" method="post">
   <tr>
     
   <td align = "center"><input type="text" placeholder="S.No" name="sno"  id="sno" required style="font-size: 15px;">
        </td>
        <td align = "center"><input type="text" placeholder="Department name" name="dep"  id="dep" required style="font-size: 15px;">
        </td>
        <td align = "center"><input type="text" placeholder="Batch no" name="btn"  id="btn" required style="font-size: 15px;">
        </td>     
...
$result=$link->query($query);
  ...
  ?>    <tr>
        ...
        <td align = "center"><?php echo $rows['batch_no']; ?></td>
        <td  align= "center" ><a href="batchview.php?upd=<?php echo $rows['sno']; ?>"><i class="fa fas fa-edit" style="color:gray; font-size: 40px; " ></i></a></td>
        <td  align= "center" ><a href="delete.php?delbt=<?php echo $rows['sno']; ?>"><i class="fa fas fa-trash" style="color:gray; font-size: 40px; " ></i> </a></td>
      </tr>
  <?php
    }
  ?> 
